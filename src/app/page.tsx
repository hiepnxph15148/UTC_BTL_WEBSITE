...
export default function Home() {
  ...
  return (
    <main className="relative min-h-dvh w-full overflow-x-hidden bg-[#181820] lg:h-dvh lg:overflow-hidden">
      <div className="relative min-h-dvh overflow-x-hidden bg-[#181820] lg:absolute lg:inset-0 lg:overflow-hidden">
